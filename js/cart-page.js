document.addEventListener("DOMContentLoaded", () => {
  ...
  function loadCartItems() {
    ...
    if (cart.length === 0) {
      ...
      document.getElementById("subtotal").textContent = "0.00 DA"
      document.getElementById("total").textContent = "0.00 DA"
      return
    }
    ...
    document.getElementById("total").textContent = `${subtotal.toFixed(2)} DA`
